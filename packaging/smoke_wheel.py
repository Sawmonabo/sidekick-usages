...
REQUIRED_WHEEL_MEMBERS = frozenset(
    {
        ...
        "sidekick_usages/core/accounts.py",
        ...
        "sidekick_usages/core/selection.py",
        ...
        "sidekick_usages/daemon/legacy.py",
        ...
        "sidekick_usages/persistence/account_schema_v3.py",
        ...
        "sidekick_usages/persistence/selection_schema.py",
