...
class SidekickUsages < Formula
  ...
  # Bundled deps. Versions match what `uv pip install sidekick-usages`
  # resolves on Python 3.14. Bump on each release with
  # `brew update-python-resources` (or our packaging/homebrew helper).
