"""Shared provider panels and wide dashboard orchestration."""
...
def heat_band(pct: int) -> tuple[str, str] | None:
...
def dashboard_overview(
    ...
    *,
    ...
    for panel in panels:
        parts.extend((panel, Text("")))
    parts.extend((_legend(), Text(""), footer_renderable(footer), Text("")))
    return Group(*parts)
