"""Provider-neutral private credential persistence boundary."""
...
if sys.platform == "darwin":
    ...
    from sidekick_usages.persistence.platform.posix.private.adapter import (
        PosixPrivateCredentialPlatform,
    )
    from sidekick_usages.persistence.platform.posix.private.bundles import (
        PosixPrivateBundlePlatform,
    )
elif sys.platform == "win32":
    from sidekick_usages.persistence.platform.windows.private.adapter import (
        WindowsPrivateCredentialPlatform,
    )
    from sidekick_usages.persistence.platform.windows.private.bundles import (
